...
import { TableRow } from "./table/table.rows"
        ...
        <div className="flex flex-col gap-4">
            <div className="flex gap-3 items-center">
                ...
                <div className="flex items-center w-72 px-3 py-1.5 border border-white/10 rounded-lg gap-3">
                    ...
                    <input onChange={onSearchInputChange} value={search} className="flex-1 bg-transparent outline-none h-auto border-0 p-0 text-sm focus:ring-0" placeholder="Buscar participantes..." />
                </div>
            </div>
            <Table>
                <thead>
                    <tr className="border-b border-white/10">
                        <TableHeader style={{width:48}}>
                            <input className="size-4 bg-black/20 rounded border border-white/10 checked:text-orange-700 focus:ring-0" type="checkbox" />
                        </TableHeader>
